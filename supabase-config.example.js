...
(function () {
  ...
  if (!window.supabase) {
    console.warn(
      "Supabase CDN não encontrado. Verifique se você incluiu o script do Supabase.",
    );
    return;
  }
  ...
  console.log(
    "Supabase client inicializado a partir de supabase-config.example.js (dev apenas)",
  );
})();
